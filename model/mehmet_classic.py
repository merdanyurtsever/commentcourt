...
@ModelRegistry.register("mehmet_classic", "Mehmet's classic placeholder model")
class MehmetClassic(BaseMLModel):
    def __init__(self, name: str = "mehmet_classic", version: str = "0.0.0"):
