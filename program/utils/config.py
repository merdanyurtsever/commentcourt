"""
Configuration Management for CommentCourt.
...
class ConfigManager:
    ...
    Loads configuration from YAML files with environment variable
    ...
    def load(self, config_path: Optional[Path] = None) -> AppConfig:
        ...
        Args:
            config_path: Path to config file (default: program/utils/config)
    ...
    def set(self, key: str, value: Any) -> None:
        ...
        Args:
            key: Configuration key (e.g., 'gui.debug')
            value: Value to set
        """
        parts = key.split('.')
        obj = self._config
    ...
    def save(self, config_path: Optional[Path] = None) -> None:
        ...
        Args:
            config_path: Path to save config (default: program/utils/config)
        """
        if config_path is None:
            config_path = DEFAULT_CONFIG_PATH
