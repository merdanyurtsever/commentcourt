...
@ModelRegistry.register("rabia_classic", "Rabia's classic placeholder model")
class RabiaClassic(BaseMLModel):
    def __init__(self, name: str = "rabia_classic", version: str = "0.0.0"):
