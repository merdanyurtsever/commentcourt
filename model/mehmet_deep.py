...
@ModelRegistry.register("mehmet_deep", "Mehmet's deep placeholder model")
class MehmetDeep(BaseMLModel):
    def __init__(self, name: str = "mehmet_deep", version: str = "0.0.0"):
