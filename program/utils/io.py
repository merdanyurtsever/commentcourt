# REMOVED: program.utils.io shim deleted (cleared)

# This module previously re-exported I/O utilities for backwards
# compatibility. It has been cleared; import from `utils.io` instead.
            for row in reader:
                rows.append(row)
        return rows
