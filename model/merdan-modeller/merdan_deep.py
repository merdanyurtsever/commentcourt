...
@ModelRegistry.register("merdan_deep", "Merdan's deep placeholder model")
class MerdanDeep(BaseMLModel):
    def __init__(self, name: str = "merdan_deep", version: str = "0.0.0"):
